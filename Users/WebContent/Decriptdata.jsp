...
function fun(){
	var no=prompt("Enter Your MeterNo"," ");
var key=prompt("Enter Your secret key"," ");
var month=prompt("Enter Month"," ");
	window.location.href="Orijinal.jsp?meterNumber="+no+" &&Key="+key+" &&Month="+month;
}
function fun1() {
	var no1=prompt("Enter Your MeterNo"," ");
	window.location.href="Decrypt.jsp?MeterNumber="+no1;
}
...
<!--                         <li><a href="MeterUpdates.jsp">Meter Updates</a></li> -->
	...
	<div class="container">
		<div class="row demobtn">
			<div class="col-lg-12">
				...
				session.setAttribute("MeterNumber", mnumber);
				...
				PreparedStatement ps=(PreparedStatement)c.prepareStatement("SELECT USkey FROM `smartgrid`.`userregistraion` where UMeterNo='"+mnumber+"'");
	...
	while(rs.next())
	{
		...
		Your SecretKey Is	:<%=Uskey%>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Don't Share to Any One
<%
				} 
			%>
			...
			<button onclick="fun1()">Show Data</button>	
			
			<input type="submit" value="Decrypt The Information" onclick="fun()">
