...
<div id="wrapper">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><span>U</span>ser's Power System</a>
                </div>
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="img/slides/us3.jpg" alt="" />
...
<!--               <li> -->
<!--                 <img src="img/slides/us4.jpg" alt="" /> -->
<!--                 <div class="flex-caption"> -->
...
<!--               </li> -->
              <li>
                <img src="img/slides/us2.jpg" alt="" />
                <div class="flex-caption">
                    <h3>Clean & Fast</h3> 
					<p> </p> 
					<a href="#" class="btn btn-theme">Learn More</a>
