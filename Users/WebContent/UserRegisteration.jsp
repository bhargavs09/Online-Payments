        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><span>WELLCOME</span>User's</a>
                </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="big-cta">
					<div class="cta-text">
						<h2><span>USER</span>Register Here</h2>


<form action="UserRegi" method="post">
MeterNumber:<input type="text" name="umeterno"><br><br>
UserName:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="uname"><br><br>
PassWord:&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="password"><br><br>
UserEmail:&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" name="uemail"><br><br>
MobileNo:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="umobileNo"><br><br>
