...
<div id="wrapper">
	...
	<div class="container">
		...
		<h3 style="color: maroon;"><center>	Your Entered Meter Number Is:::	<%=request.getParameter("MeterNumber") %></center></h3>
				 
				 

					  <%session.setAttribute("meternumber", request.getParameter("MeterNumber") ) ;%>
