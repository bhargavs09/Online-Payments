        ...
        <div class="container" >
            <div class="row main-top-margin text-center">
                <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1" data-scrollreveal="enter top and move 100px, wait 0.5s">
                   <h2 class="h2-4">Online Transfer:</h2>
               
                <form action="Transfer" method="post" >
            <fieldset>
           
                <div>
                    <input type="text" value="<%=session.getAttribute("accno") %>" placeholder="Enter Account Number" name="acount"/><br><br>
                </div>
                 <div>
                    <input type="text" name="user" placeholder="Enter UserName"/><br><br>
                </div>
                <div>
                    <input type="number" name="money" placeholder="Enter your Money"/><br><br>
                </div>
                  <div>
