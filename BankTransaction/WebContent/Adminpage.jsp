            ...
            <div class="row main-top-margin text-center">
		       ...
		       <form method="post" action="Adminlogin">
			          <h1>ADMIN SIGN IN FORM</h1>
						...
						<input type="text" name="name" class="text" placeholder="Your Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Name';}" ><br><br>
						<input type="password" name="pass" class="text" placeholder="Your Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Password';}" ><br><br>
