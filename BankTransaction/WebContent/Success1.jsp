...
<!--                     <h2 class="h2-4">Check Balance:</h2> -->
...
<!--                 </div> -->
                ...
                <marquee bgcolor="#66CD00">YOUR ACCOUNT HAS BEEN CREATED SUCCESSFULLY ***SBI***</marquee>
...
<!--     </div>   -->
    ...
    <marquee bgcolor="#66CD00"> YOUR ACCOUNT HAS BEEN CREATED SUCCESSFULLY !!! THANK YOU FOR USING***SBI***</marquee> <br><br><br> <br><br><br>
    
<!--     <marquee bgcolor="#FF00FF" direction="up"><center>THANK YOU</center></marquee><br><br><br> -->
<!--     <img src="assets/img/su3.png" alt="" /> -->
   <center> <img src="assets/img/su2.jpg" alt="" /></center>
   
    
    <div id="footer">
        <div class="container">
            <div class="row ">
                &copy; 2017 www.sbionline.com | All Right Reserved 				
